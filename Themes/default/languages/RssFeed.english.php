...
$txt['RssFeed_feed_url'] = 'Feed URL';
$txt['RssFeed_feed_url_desc'] = 'This should be a valid RSS feed.  If the parser finds it to be invalid, it will be disabled.';
$txt['RssFeed_feed_poster'] = 'Post Feed As';
$txt['RssFeed_feed_poster_desc'] = 'Enter who you would like this topic posted as.';
$txt['RssFeed_feed_prefix'] = 'Topic Prefix';
$txt['RssFeed_feed_prefix_desc'] = 'If you would like this feed\'s posts prefixed, enter one here.  This is optional';
$txt['RssFeed_feed_import'] = 'Number To Import';
$txt['RssFeed_feed_import_desc'] = 'You can set the number of items to import on each load.  0 to import all.';
...
$txt['RssFeed_feed_insert_success'] = 'The feed was created successfully';
$txt['RssFeed_feed_update_success'] = 'The feed was updated successfully';
